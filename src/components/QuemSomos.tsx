                    ...
                    <div className="mt-16 border-t border-slate-800 pt-12">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center opacity-70">
                            ...
                            <div className="grayscale hover:grayscale-0 transition-all">
                                <Image src="/logoGrupoCunhaSilva.png" alt="Fluxus" width={150} height={80} className="object-contain" />
                            </div>
                            <div className="grayscale hover:grayscale-0 transition-all">
                                <Image src="/livrariaAbraao.png" alt="Empresa 2" width={150} height={80} className="object-contain" />
                            </div>
                            <div className="grayscale hover:grayscale-0 transition-all">
                                <Image src="/restauranteDaju.png" alt="Empresa 3" width={150} height={80} className="object-contain" />
                            </div>
                            <div className="grayscale hover:grayscale-0 transition-all">
                                <Image src="/acheiLa.png" alt="Empresa 4" width={150} height={80} className="object-contain" />
                            </div>
